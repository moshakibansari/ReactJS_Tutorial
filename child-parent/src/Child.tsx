    ...
    render(){
        return(
            <React.Fragment>
                ...
                <br></br>
                <button onClick={()=>{this.props.fun_one(this.ref1.current?.value)}} style={{marginRight:100}}>Button1</button>
                <button onClick={()=>{this.props.fun_one(this.ref2.current?.value)}}style={{marginRight:100}}>Button2</button>
                <button onClick={()=>{this.props.fun_one(this.ref3.current?.value)}}style={{marginRight:100}}>Button3</button>
            </React.Fragment>
        )
    };
};
